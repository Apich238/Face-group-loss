...
def main(args):
    ...
    n=10
    centers_decay = 0.9
    mx, sd, centers, embeddings = sphere_loss.get_sphere_loss(features, images_per_class, R, n)
    ...
    logdir = r'C:\models\mnist_conv_myloss_v3_6-' + datetime.strftime(datetime.now(), '%Y%m%d-%H%M%S') + '_features=' + str(
        features_sz) + '_n='+str(n)+'_R='+str(R)
